...
import Adarsh from '../../../public/images/profile.png';

const Intro = () => {
  return (
    <>
      {/* fixed at top */}
      <div className='headerr z-50 absolute bg-MidNightBlack backdrop-blur-sm inset-y-0 h-[194px] top-0 flex items-center justify-center w-full flex-col px-4 gap-y-4'>
        <Image className='w-[90px] h-[90px] rounded-full' src={Adarsh} alt='profile picture' />
      ...
      {/* middle components */}
      <div className='beech z-20 flex flex-col overflow-y-scroll pt-48 top-55 space-y-6 divide-y divide-white overflow-x-hidden no-scrollbar px-4'>
